...
<figure>
  <img src="https://github.com/DejavuForensics/SVM/blob/main/EN-US/SVM_1.png" alt="Successful performances of the _kernels_ compatible with the datasets."  style="width:50%; height:50%;">
